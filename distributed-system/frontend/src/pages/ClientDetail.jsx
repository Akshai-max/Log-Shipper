          ...
          <div style={{ height: '280px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip contentStyle={{ backgroundColor: '#0f172a', borderColor: '#334155', borderRadius: '8px' }} itemStyle={{ color: '#f8fafc', fontWeight: '500' }} formatter={(value, name) => [value.toFixed(1) + 's', getDomainMeta(name).label]} />
              </PieChart>
            </ResponsiveContainer>
          </div>
        </div>
